...
> **Отчет сгенерирован:** 12.09.2025, 10:00:14
...
- **modelstestts** [73% / 78%] - filepath: src/__tests__/models.test.ts
...
- **matrixcontainertestts** [64% / 71%] - filepath: src/__tests__/matrix-container.test.ts
- **segmentdisplaytestts** [64% / 71%] - filepath: src/__tests__/segment-display.test.ts
- **MockProject** [63% / 56%] - Mock Project implementation
- **selectionservicetestts** [63% / 71%] - filepath: src/__tests__/selection.service.test.ts
...
### 9. ✨ **CODE QUALITY (Качество кода)** [58% / 56%]
...
### 10. 📦 **DEPENDENCIES (Зависимости)** [52% / 52%]
