...
> **Отчет сгенерирован:** 12.09.2025, 11:30:15
...
- **simpleanalyzertestts** [75% / 79%] - Comprehensive Test Suite для SimpleTechnicalDebtAnalyzer v2.0
...
- **fileanalysisutilstestts** [71% / 73%] - Тесты для FileAnalysisUtils
...
- **PerformanceReporter** [59% / 46%] - ╔═══════════════════════════════════════════════════════════════╗   ║              PERFORMANCE METRI
...
- **debtmetricscalculatortestts** [54% / 42%] - /
...
- **testanalyzermanualts** [53% / 41%] - Test script for SimpleTechnicalDebtAnalyzer v2.0
...
### 7. ✨ **CODE QUALITY (Качество кода)** [61% / 58%]
