...
> **Отчет сгенерирован:** 12.09.2025, 13:31:12
...
- **WebSecurityChecker** [93% / 84%] - WebSecurityChecker - Главный анализатор веб-безопасности     Координирует анализ XSS, CSRF и други
...
- **BaseSecurityProcessor** [77% / 78%] - SecurityChecker v2.0 - Оптимизированный анализатор безопасности     Ключевые улучшения:   - Устра
...
- **FileStructureAnalyzer** [77% / 79%] - Fiimport FileSystemScanner, { type ScannedFile } from './FileSystemScanner.js'; import MetricsCalcu
...
- **testtask12** [60% / 47%] - 🧪 ТЕСТ РЕПОРТЕРОВ EAP ANALYZER v6.0   Тестирование MarkdownReporter и улучшенного HTMLReporter
...
- **testsecuritycheckeroptimization** [56% / 44%] - SecurityChecker v2.0 Optimization Test   Проверяет производительность оптимизированного SecurityChe
