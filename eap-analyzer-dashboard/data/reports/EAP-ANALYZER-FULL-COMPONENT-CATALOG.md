...
> **Отчет сгенерирован:** 11.09.2025, 20:44:23
...
- Компонентов: 2
- Средняя готовность: 94%
- Средняя функциональность: 75%

### 2. ⚡ **PERFORMANCE (Производительность)** [89% / 76%]
...
### 3. ✨ **CODE QUALITY (Качество кода)** [85% / 67%]
...
- **demo** [68% / 86%] - Простая демонстрация системы генерации дорожных карт рефакторинга Тестовая версия для проверки фун
...
### 8. 🐳 **DOCKER (Контейнеризация)** [70% / 58%]
...
### 9. 🔄 **CI/CD (Непрерывная интеграция)** [70% / 45%]
...
### 11. 🤖 **AI (Искусственный интеллект)** [57% / 53%]

- **cli** [73% / 80%] - # sourceMappingURL=cli.js.map
...
- **Всего компонентов:** 308
- **Средняя готовность логики:** 79%
