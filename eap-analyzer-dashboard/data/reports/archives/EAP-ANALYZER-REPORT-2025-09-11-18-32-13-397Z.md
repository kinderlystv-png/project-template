...
> **Отчет сгенерирован:** 11.09.2025, 21:32:13
...
- **performancebenchts** [75% / 81%] - Тесты производительности для EAP Analyzer   Измеряют производительность ключевых функций анализа
