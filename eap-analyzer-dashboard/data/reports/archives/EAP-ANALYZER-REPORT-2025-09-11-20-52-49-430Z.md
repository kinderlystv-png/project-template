...
> **Отчет сгенерирован:** 11.09.2025, 23:52:49
...
- **RecommendationEngine** [80% / 82%] - RecommendationEngine - Система практических рекомендаций по безопасности     Phase 5.2.1: Создание
...
- **PackageJsonAnalyzer** [95% / 86%] - Анализатор package.json для тестовых фреймворков и конфигураций
...
- **JestCheckerAdapter** [77% / 71%] - Адаптер JestChecker для интеграции с AnalysisOrchestrator
...
### 7. ✨ **CODE QUALITY (Качество кода)** [67% / 63%]

- **EMTAnalyzer** [91% / 92%] - EMT модуль - анализирует проекты на базе EMT Framework
...
### 9. 🐳 **DOCKER (Контейнеризация)** [60% / 57%]
...
### 10. 🤖 **AI (Искусственный интеллект)** [60% / 53%]
