...
> **Отчет сгенерирован:** 12.09.2025, 21:44:38
...
- **runorchestratordebuggerts** [62% / 62%] - Запуск EAP Debugger для текущего состояния оркестратора
...
- **runsimpledebuggerts** [58% / 58%] - Простой запуск EAP Debugger для проверки оркестратора
...
- **testeapfinal** [54% / 44%] - Simple Node.js test script for EAP Debugger
...
- **testeapanalyzerenhancedts** [53% / 41%] - Test script for enhanced EAP analyzer with actual project analysis   Проверяет работу анализатора с
...
- **testeapenhanced** [52% / 41%] - Simple test script for enhanced EAP analyzer   Tests the analyzer with actual project analysis on C
...
- **minitest** [50% / 38%] - Мини-тест FileStructureAnalyzer v3.0   Проверяет, что это реальный анализатор, а не демо
...
- **runfixeddebuggerts** [58% / 58%] - Обновленный простой запуск EAP Debugger с правильной интеграцией FileStructureChecker
...
- **debugeap** [42% / 41%] - Быстрый запуск EAP Debugger   Использование: npm run debug-eap
