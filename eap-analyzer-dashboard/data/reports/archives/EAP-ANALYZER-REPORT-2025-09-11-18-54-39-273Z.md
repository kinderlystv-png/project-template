...
- **performancesetupts** [88% / 90%] - Performance Testing Setup   Инициализация системы отчетов и автоматизации     @author EAP Analyze
- **HtmlReportGenerator** [88% / 80%] - Performance Report Generator   Автоматизация создания HTML отчетов и уведомлений     @author EAP 
...
- **DataGenerator** [85% / 92%] - BenchUtils - Утилиты для тестов производительности   Устраняет дублирование логики в тестах произво
