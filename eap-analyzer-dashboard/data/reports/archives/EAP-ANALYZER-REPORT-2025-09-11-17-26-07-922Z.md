...
> **Отчет сгенерирован:** 11.09.2025, 20:26:07
...
### 7. 🐳 **DOCKER (Контейнеризация)** [71% / 60%]
...
- **fileutils** [80% / 90%] - Утилиты для работы с файлами и кодировками (TypeScript версия)
...
- **adaptivethresholds** [78% / 92%] - Конфигурация с адаптивными порогами (TypeScript версия)
