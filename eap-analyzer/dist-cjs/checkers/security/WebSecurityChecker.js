...
exports.WebSecurityChecker = void 0;
const XSSAnalyzer_js_1 = require('./analyzers/XSSAnalyzer.js');
const CSRFAnalyzer_js_1 = require('./analyzers/CSRFAnalyzer.js');
class WebSecurityChecker {
  xssAnalyzer = new XSSAnalyzer_js_1.XSSAnalyzer();
  csrfAnalyzer = new CSRFAnalyzer_js_1.CSRFAnalyzer();
  /**
   * Выполняет полный анализ веб-безопасности
   */
  async analyzeWebSecurity(context) {
   ...
   */
  createWebSecurityResult(xssResult, csrfResult) {
   ...
   */
  generateBasicRecommendations(xssResult, csrfResult) {
...
exports.WebSecurityChecker = WebSecurityChecker;
//# sourceMappingURL=WebSecurityChecker.js.map
