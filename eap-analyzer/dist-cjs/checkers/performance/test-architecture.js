...
exports.testPerformanceArchitecture = testPerformanceArchitecture;
const PerformanceChecker_1 = require('./PerformanceChecker');
const BundleSizeAnalyzer_1 = require('./BundleSizeAnalyzer');
async function testPerformanceArchitecture() {
  ...
  performanceChecker.registerAnalyzer(new BundleSizeAnalyzer_1.BundleSizeAnalyzer());
