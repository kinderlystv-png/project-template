...
exports.SmartFileClassifier = exports.Framework = exports.FileCategory = void 0;
/**
...
(function (FileCategory) {
    ...
    FileCategory["BUILD_SCRIPT"] = "build_script";
...
class SmartFileClassifier {
    ...
    classifyGenerated(filePath, content) {
        // Проверка пути
    ...
    classifySourceCode(filePath, content) {
    ...
    detectFramework(filePath, content) {
        for (const [framework, markers] of Object.entries(this.frameworkMarkers)) {
            ...
            if (framework === 'vue' && filePath.endsWith('.vue'))
                score += 3;
            if (framework === 'svelte' && filePath.endsWith('.svelte'))
                score += 3;
            if (score >= 3) {
                return framework;
            }
    ...
    detectFrameworkByPath(filePath) {
...
exports.SmartFileClassifier = SmartFileClassifier;
