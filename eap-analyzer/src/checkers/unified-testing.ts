...
export class TestingChecker {
   ...
   */
  private static createComponentResult(checkResults: CheckResult[], startTime: number): ComponentResult {
   ...
   */
  private static createErrorResult(error: any, startTime: number): ComponentResult {
    const errorCheck = {
