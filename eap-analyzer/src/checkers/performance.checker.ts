...
export class PerformanceChecker extends BaseChecker {
  readonly name = 'Performance Check';
  readonly category = 'performance' as const;
  readonly description = 'Проверка общих проблем производительности';
  ...
  private checkViteConfig(content: string, issues: string[], recommendations: string[]): void {
  ...
  private checkWebpackConfig(content: string, issues: string[], recommendations: string[]): void {
