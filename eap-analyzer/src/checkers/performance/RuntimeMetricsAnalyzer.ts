...
export class RuntimeMetricsAnalyzer implements IPerformanceAnalyzer {
   ...
   */
  private async analyzeJavaScriptPerformance(projectPath: string): Promise<{
    metrics: Record<string, unknown>;
    penalty: number;
    issues: Array<{ severity: string; message: string }>;
    recommendations: string[];
   ...
   */
  private async analyzeCoreWebVitals(projectPath: string): Promise<{
    metrics: Record<string, unknown>;
    penalty: number;
    issues: Array<{ severity: string; message: string }>;
    recommendations: string[];
   ...
   */
  private async analyzeDOMOperations(projectPath: string): Promise<{
    metrics: Record<string, unknown>;
    penalty: number;
    issues: Array<{ severity: string; message: string }>;
    recommendations: string[];
   ...
   */
  private async analyzeMemoryPatterns(projectPath: string): Promise<{
    metrics: Record<string, unknown>;
    penalty: number;
    issues: Array<{ severity: string; message: string }>;
    recommendations: string[];
   ...
   */
  private async analyzeFrameworkPerformance(projectPath: string): Promise<{
    metrics: Record<string, unknown>;
    penalty: number;
    issues: Array<{ severity: string; message: string }>;
    recommendations: string[];
  ...
  private async analyzeLCPFactors(projectPath: string) {
    let largeImages = 0;
  ...
  private async analyzeFIDFactors(projectPath: string) {
    const jsFiles = await this.findJavaScriptFiles(projectPath);
    let heavyJSBlocks = 0;
    let longTasks = 0;
  ...
  private async analyzeCLSFactors(projectPath: string) {
    const jsFiles = await this.findJavaScriptFiles(projectPath);
  ...
  private async analyzeReactPerformance(projectPath: string) {
    const metrics: Record<string, unknown> = {};
    let penalty = 0;
    const issues: Array<{ severity: string; message: string }> = [];
    const recommendations: string[] = [];
  ...
  private async analyzeVuePerformance(projectPath: string) {
    const metrics: Record<string, unknown> = {};
    let penalty = 0;
    const issues: Array<{ severity: string; message: string }> = [];
    const recommendations: string[] = [];
  ...
  private async analyzeSveltePerformance(projectPath: string) {
    const metrics: Record<string, unknown> = {};
    let penalty = 0;
    const issues: Array<{ severity: string; message: string }> = [];
    const recommendations: string[] = [];
...
export default RuntimeMetricsAnalyzer;
